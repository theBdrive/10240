...
class bootGame extends Phaser.Scene{
    ...
    preload(){
        this.load.image("restart", "assets/sprites/restartBtn.png");
...
class playGame extends Phaser.Scene{
    ...
    create(){
        ...
        this.bestScore = localStorage.getItem(gameOptions.localStorageKey);
                ...
                if(tileValue != 0){
                    ...
                    if(newRow != curRow || newCol != curCol){
                        ...
                        if(willUpdate){
                            ...
                            scoreToAdd = Math.pow(2, this.boardArray[newRow][newCol].tileValue);
                            switch(scoreToAdd){
                                case 4:
                                    this.score += 10;
                                break;
    ...
    moveTile(tile, point, upgrade){
        ...
        this.tweens.add({
            ...
            x: point.x,
            y: point.y,
            duration: gameOptions.moveSpeed * distance / gameOptions.tileSize,
            callbackScope: this,
            onComplete: function(){
                if(upgrade){
    ...
    upgradeTile(tile){
        ...
        this.tweens.add({
            ...
            scaleX: 1.1,
            scaleY: 1.1,
            duration: gameOptions.growSpeed,
            yoyo: true,
            repeat: 1,
            callbackScope: this,
            onComplete: function(){
    ...
    refreshBoard(){
        ...
        if(this.score > this.bestScore){
            ...
            localStorage.setItem(gameOptions.localStorageKey, this.bestScore);
